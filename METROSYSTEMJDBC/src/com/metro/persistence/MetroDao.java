...
public interface MetroDao {
	...
	boolean addCard(int id,int balance) throws SQLException, ClassNotFoundException;
	...
	Collection<MetroCard> getAllRecords() throws ClassNotFoundException, SQLException;
